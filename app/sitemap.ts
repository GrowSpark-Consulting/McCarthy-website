...
const ROUTES = [
  ...
  '/ai-workforce/',
  '/ai-lab/',
  '/ai-lab/ai-ceo-command-center/',
  '/ai-lab/ai-sales-agent/',
  '/ai-lab/ai-operations-manager/',
  '/ai-lab/ai-customer-service/',
  '/ai-lab/ai-employee-knowledge-hub/',
  '/ai-lab/ai-finance-intelligence/',
  '/ai-lab/ai-recruitment-assistant/',
  '/ai-lab/ai-document-intelligence/',
  '/ai-audit/',
  '/industries/',
  '/case-studies/',
  '/rnd/',
